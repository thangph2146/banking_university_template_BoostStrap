document.addEventListener('DOMContentLoaded', function() {
    ...
    function animateElements() {
        const elements = [
            ...
            {selector: '.square-avatar-container', animation: 'scale-in', delay: 400},
            {selector: '.guest-info', animation: 'slide-up', delay: 600},
    ...
    const sampleData = {
        ...
        "Text2": "Welcome to Banking University Ho Chi Minh City"
    };
